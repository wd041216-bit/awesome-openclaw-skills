...
- [openclaw-free-web-search](https://github.com/openclaw/skills/tree/main/skills/wd041216-bit/openclaw-free-web-search/SKILL.md) - **v13.0.0** — Free, privacy-first web search for OpenClaw powered by [free-web-search-ultimate](https://github.com/wd041216-bit/free-web-search-ultimate). Enforces a **Search-First** paradigm: the agent searches the web before answering factual questions. Supports 10+ search engines (DuckDuckGo, Bing, Brave, Wikipedia, Arxiv, YouTube, Reddit). Zero API keys, zero cost. Tells you how much to trust the answer.
